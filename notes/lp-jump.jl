...
# ╔═╡ 91e80254-ab22-11ec-10aa-0fcd92bacb88
using JuMP, PlutoUI

# ╔═╡ b202edea-3b24-406c-9a70-1db2cbb37e99
md"""
# Linear Programming with JuMP
"""

# ╔═╡ f156cea2-603b-4507-b262-14cb465f2fa9
import Clp, HiGHS

# ╔═╡ 9e23a531-2209-4092-a1de-68d4edcba8fb
begin
	A = [-2 1 1 0 0
	     -1 2 0 1 0
	      1 0 0 0 1]
...
# ╔═╡ 13dd4455-704d-4df4-b151-7452591f9c51
begin
	...
	## HiGHS options
	set_optimizer_attribute(model, "highs_debug_level", 1)
	set_optimizer_attribute(model, "log_dev_level", 3)
...
# ╔═╡ 96d97354-e899-4dd9-9bd3-92fcc121dafb
solution_summary(model, verbose=true)

# ╔═╡ e5149742-094e-4cc0-acb2-43b50ebf5b89
md"""
## Convex modeling language
"""

# ╔═╡ fe0b5915-09ad-4991-86c2-0379f6870acc
import Convex, SCS, LinearAlgebra, GLPK

# ╔═╡ 568f5f4a-64fa-4b02-991b-cbfc5501f9b2
xv = let
	x = Convex.Variable(n)
	p = Convex.minimize( Convex.norm(A*x-b, Inf) )
	Convex.solve!(p, HiGHS.Optimizer, verbose=true, silent_solver=false)
	with_terminal() do
		@show p.optval
		@show x.value
	end
...
# ╔═╡ ae48cae2-1f87-439f-b7a2-91f7cd7919df
A*xv - b
