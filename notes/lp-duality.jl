...
# ╔═╡ e88781de-aed3-11ec-33ec-a5846d05897b
using JuMP, Ipopt, Plots, HiGHS

# ╔═╡ 7c9b81ef-67ba-45cc-bd10-a360bd057628
md"""
# LP Duality
"""

# ╔═╡ 2b478e92-8e5d-4203-940f-31a8e48f3333
md"""
A simple quadratic optimization problem:

$$\min_{x_1,x_2}\{x_1^2 + x_2^2 \mid x_1+x_2=1\}$$

"""

# ╔═╡ 9f78c416-1c07-4687-900a-ed1a1db581e7
begin
	...
	@NLobjective(model, Min, x1^2 + x2^2)
	optimize!(model)
	value.([x1, x2]), objective_value(model)
end

# ╔═╡ a4d1b48a-3529-4f58-81a1-f7392c55d609
md"Define dual function $g$:"

# ╔═╡ 1123df22-126e-4225-b480-d1e311cc3ccc
function g(y)
	model = Model(Ipopt.Optimizer)
	set_silent(model)
	@variable(model, x1)
	@variable(model, x2)
	@NLobjective(model, Min, x1^2 + x2^2 + y*(1 - x2 - x1))
	optimize!(model)
	objective_value(model)
end

# ╔═╡ 8abf300c-6f46-4129-a73d-55376af2d3b7
plot(g, -1, 3)

# ╔═╡ b136d9f6-5499-4121-921b-699508e34022
begin
	A = [-2 1 1 0 0
	     -1 2 0 1 0
	      1 0 0 0 1]
...
# ╔═╡ 85c995a9-7b7d-4021-9ec4-8765ced6ba78
md"""
## Primal problem
"""

# ╔═╡ 01036d30-c3fb-4069-95ac-fba08c405097
x, yy = let
...
# ╔═╡ d87246f1-eab7-4fb3-b067-937806dd5ff8
p = c'x

# ╔═╡ 4fb2b360-68fa-4e1a-be23-10a8dd9b6062
md"""
## Dual problem
"""

# ╔═╡ d17c22ef-1236-4468-abed-79ed4df93625
y = let
	model = Model(HiGHS.Optimizer)
	@variable(model, y[1:m])
	@objective(model, Max, b'y)
	@constraint(model, con, c - A'y .≥ 0)
	set_silent(model)
	optimize!(model)
	value.(y)
end

# ╔═╡ 5f3b3891-90fe-468c-badc-61386c126859
d = b'y
