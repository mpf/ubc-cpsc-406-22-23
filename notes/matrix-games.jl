...
# ╔═╡ a8fab1fa-c21a-468b-b2c4-7c4227fb979a
using JuMP, HiGHS, LinearAlgebra

# ╔═╡ 176faf8e-da21-11ed-086a-2f1962857849
md"# Matrix Games"

# ╔═╡ a8b2f40f-d654-408c-8d17-cf5f7322e562
md"""
## Rock, Paper, Scissors
"""

# ╔═╡ 1280a06b-bfbb-4d37-8f87-1650dea12895
md"Payoff matrix $A$:"

# ╔═╡ 6a3702e3-bd49-4e15-b148-128fff258e24
#     rock  paper  scissors
A = [ 0     +1     -1      # rock
     -1      0     +1      # paper
     +1     -1      0      # scissors
...
# ╔═╡ 813750cf-73d9-43b8-8335-252e964532b3
md"""
### Player X's problem
"""

# ╔═╡ ad5a76ae-17d6-40b7-ab5d-78a3ead928dc
function playerX(A::Matrix)
	m, n = size(A)
	...
	@constraint(model, xcon, λ .≤ A*x)
	@objective(model, Max, λ)
	optimize!(model)
	return value.(x), objective_value(model)
end

# ╔═╡ 3f3aa6a9-96a9-450c-89f6-f7673a9e86d1
md"### Player Y's problem"

# ╔═╡ a9492a83-0547-4cc9-8deb-9c3cdd3d7602
function playerY(A::Matrix)
	m, n = size(A)
	model = Model(HiGHS.Optimizer)
	set_silent(model)
	...
	@constraint(model, ycon, ν .≥ A'y)
	@objective(model, Min, ν)
	optimize!(model)
	return value.(y), objective_value(model)
end

# ╔═╡ 8b5d9c0c-47ca-42c0-8666-7d3eef52bf59
playerX(A)

# ╔═╡ 86116587-c804-4680-9a2f-5456c2e21d68
playerY(A)

# ╔═╡ 37258aad-9b23-4ccc-8253-d10805d99f46
md"## Helper functions"
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1bb5543e0132d4c43f04e7056d7759f71703554d"
