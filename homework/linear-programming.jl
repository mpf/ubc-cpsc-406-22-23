...
# ╔═╡ d56ebfcd-2c5f-4e21-a4c9-44c73be68d00
using LinearAlgebra, Random, JuMP, HiGHS, Statistics, Plots

# ╔═╡ e4bcc583-0af4-45c6-9824-86a548d79112
...
# ╔═╡ 261a62de-d8f0-11ed-324e-0fa7b81588a0
md"""Student: **$(student.name)** (ID# $(student.ubcid))"""

# ╔═╡ b49c68b0-f3bc-495b-a8d3-7d4ee098f0d5
md"""
# Homework 8: Linear Programming
"""

# ╔═╡ 5c713a05-1e2c-4206-b8a1-fde429313be0
md"""
## Exercise 1: Simplex

1. Convert this problem into standard form and construct a basis that corresponds to the point $x=(0,0)$:

$$\begin{align}
 \min_{x_1,x_2} &\quad {-}2x_1-x_2\\
 \text{subj to} &\quad x_1+x_2 \le 6,\ x\ge0.
\end{align}$$

2.  Carry out the steps of the simplex method, starting with the basic feasible solution above. At each iteration, show the basic index set, the reduced costs, and which variables enter and leave the basis.
...
# ╔═╡ ed780b9c-049e-4672-9fab-c7e6cef5f132
# answer here

# ╔═╡ 049a884e-0aa1-4568-8098-7e381d3f68c9
md"""
...
$$\begin{equation}
    \min_{x}\;\|Ax-b\|_1 = \sum_{i=1,\ldots,m}|a_i^T x-b_i|
\end{equation}$$
 
$$\begin{equation}
    \min_{x}\;\|Ax-b\|_\infty = \max_{i=1,\ldots,n}|a_i^T x-b_i|
\end{equation}$$

$$\begin{equation}
    \min_{x}\;\|Ax-b\|_2 =\sqrt{ \sum_{i=1,\ldots,n}|a_i^T x-b_i|^2}
\end{equation}$$
"""

# ╔═╡ 88aa630e-e6cc-455a-b4a9-73112dda0b5a
md"""
**Part (a).** Write the one-norm problem as a linear program of the form

$$\begin{equation}\label{eq:linprog-form}
        \min_{z}\ c^T z \text{ subject to } \hat{A} z \leq \hat{b},
\end{equation}$$
    
for some $c$, $\hat{A}$, and $\hat{b}$.
"""

# ╔═╡ 2a372f65-88f9-48ac-8b7b-7cfe404facdd
# answer here

# ╔═╡ b0bb5d61-6afc-4c03-8c95-6dd14c1e3e3f
md"""
**Part (b)**. Similarly, write the one-norm problem as a linear program.
"""

# ╔═╡ 5304c4e2-2184-446d-b955-ec53d8112700
# answer here

# ╔═╡ 18ee4b68-7953-4977-9fb1-fae480672b4f
md"""
**Part (c).** For some randomly generated data (below), plot histograms of the residuals obtained by each of the three formulations.

Here's the data:
"""

# ╔═╡ 7ed3b8dc-af00-43e5-984b-75b74b555358
begin
	Random.seed!(1)
	m = 400
	n = 200
...
# ╔═╡ 67689ed7-f5ed-45d4-b574-751817fef2fe
md"The histogram for the least-squares problem."

# ╔═╡ 2cd8325e-414c-4e23-a39c-21dd5ed143e5
begin
	x_ls = A \ b
	r_ls = A*x_ls - b
	histogram(r_ls, bins=-3:.1:3)
end

# ╔═╡ ec8f86dd-7c70-4e88-b980-40118a14823a
md"Produce the historgrams for the one- and inf-norm formulations, using the same data above."

# ╔═╡ 0d22c3c8-b55a-41b6-973e-a98d4cea2f41
# answer here

# ╔═╡ 8a3c4bec-d6f9-40bb-9710-dbef88756aae
md"## Helper code"
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "af77fcb5c339bb5f62a0e8a0be1ea94705e73a37"
