...
# ╔═╡ 03b47ffa-ee46-4c1f-be21-3f43c211882b
using LinearAlgebra, Random, CSV, DataFrames, Statistics, Plots

# ╔═╡ fd475ac2-b151-495c-992e-c8a594d6bd90
...
# ╔═╡ 8f78e770-dda4-4cd6-b8c1-f7993b0eafae
md"""Student: **$(student.name)** (ID# $(student.ubcid))"""

# ╔═╡ 19085aff-f3aa-4ece-915b-4e88e16de849
md"""
# CPSC 406 — Homework 7
"""

# ╔═╡ 64666a1a-cebc-453a-8388-83ad8ee4d81d
md"""
...
# ╔═╡ 1ab340af-eecd-4533-ae04-9dbea4e0f352
# Answer here

# ╔═╡ c3a4cfa1-65b5-4910-bd7e-a0028f20f054
md"""
**(Part b.)** Implement your solution above by completing the following function.
"""

# ╔═╡ d59ceae2-5bbb-4005-9092-45b01277c13a
# Answer here
"""
...
# ╔═╡ 89cd142d-263e-4ad1-9034-2347cc5576c0
md"**(Part c.)** Verify numerically with a few examples that your projection code is correct."

# ╔═╡ 2845cbb3-233b-4bc1-b522-a91db00f166e
# code here...

# ╔═╡ c9cc4ffa-5a21-4a5c-b532-ca2ad53177c3
md"""
...
# ╔═╡ 7cb77d3b-10c0-4a2e-bcd3-8df99d6f1025
md"""
...
# ╔═╡ 6e8bcee5-1ad2-4e62-93ef-038337b7d4d2
md"**(Part a.)** Complete the following function."

# ╔═╡ c9ea95eb-df0d-45eb-ae4a-bc008dd26418
"""
...
# ╔═╡ b4bbd6cd-c622-44fb-abaf-4f9ee725c73d
md"""
...
# ╔═╡ 053ffb2b-632a-4939-964e-19ea1e4e71bb
# Answer here

# ╔═╡ 91afe5bf-bfdb-470b-8025-47fc1aece514
md"""
## Exercise 3. Projected gradient method.
"""

# ╔═╡ 3dedec75-d6f0-48ee-a9c6-00624a36842c
md"""
...
# ╔═╡ 32a209db-2ba5-4d71-9c77-71d62d55a13b
"""
...
# ╔═╡ ca5d15cb-9ad6-4adc-9ad5-391c41f53cfe
md"""
...
# ╔═╡ 2b4d2f39-b943-4180-ac4c-6474bee5f596
...
# ╔═╡ bf4ff882-046e-4c10-a36e-276075ff7667
md"""
...
# ╔═╡ 069bb7e7-a956-4d7b-bc00-f64bc818cf7e
"""
...
# ╔═╡ 6d77a73a-3003-4b66-85ea-ecd04da99d62
let
	b = [12.0, -23.0, 16.0]
	x = proj_simplex(b)
end

# ╔═╡ f4eef581-17f2-4ef8-92d1-de7cd5594e4f
stocks = 
...
# ╔═╡ e07c50f8-ca5d-47f2-9d08-7001d30e4893
tmpdir = mktempdir();

# ╔═╡ 6dbf55f0-d962-410f-ab90-d6630f4b3c37
for s in stocks
...
# ╔═╡ 4a175806-229d-4c07-8f71-e544dc87b873
...
# ╔═╡ 5179d26b-d8a8-4fec-a7ff-153117fd520d
function meancov(df)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "ca4e35d843dfdca4b16be2539828d955973f1870"
